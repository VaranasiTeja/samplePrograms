...
public class PrimeNumberGeneratorTest {
	...
	// primeNumberGenerator.generatePrimeNumbersInRange(10, 20));
	// Assert.assertTrue(false);
	// Assert.assertEquals(primeNumberGenerator.generatePrimeNumbersInRange(10,
	// 15),
	...
	// primeNumberGenerator.generatePrimeNumbersInRange(0, 15));
	// Assert.assertEquals(primeNumberGenerator.generatePrimeNumbersInRange(0,
	// 15),
	...
	// Assert.assertEquals(primeNumberGenerator.generatePrimeNumbersInRange(15,
	...
	// primeNumberGenerator.generatePrimeNumbersInRange(0, 1));
	// Assert.assertEquals(new ArrayList<Integer>(Arrays.asList(2, 3, 5, 7)),
	// primeNumberGenerator.generatePrimeNumbersInRange(10, -10));
	// Assert.assertEquals(new ArrayList<Integer>(Arrays.asList(2, 3, 5, 7)),
	// primeNumberGenerator.generatePrimeNumbersInRange(-10, 10));
	// Assert.assertEquals(new ArrayList<Integer>(),
	// primeNumberGenerator.generatePrimeNumbersInRange(-15, -15));
	// Assert.assertEquals(new ArrayList<Integer>(),
	// primeNumberGenerator.generatePrimeNumbersInRange(-10, -30));
	// Assert.assertEquals(primeNumberGenerator.generatePrimeNumbersInRange(-30,
	// -3), new ArrayList<Integer>());
	// }
	//
	// @Test
	...
	// Assert.assertEquals(primeNumberGenerator.generatePrimeNumbersTillEndingNumber(0),
	// new ArrayList<Integer>());
	// Assert.assertEquals(primeNumberGenerator.generatePrimeNumbersTillEndingNumber(10),
	// new ArrayList<Integer>(Arrays.asList(2, 3, 5, 7)));
	// Assert.assertEquals(primeNumberGenerator.generatePrimeNumbersTillEndingNumber(2),
	// new ArrayList<Integer>());
	// }
	...
	// System.out.println("normal Way :" + (endingTime - startingTime) /
	// 1000000000);
	// }

	@Test
	public void testPrimesUsingSieves() {
		System.out.println("####" + primeNumberGenerator.generatePrimeNumbersBySeive(50));
		...
		// Assert.assertEquals(new ArrayList<Integer>(),
		// primeNumberGenerator.generatePrimeNumbersBySeive(2));
	}
	...
	public void testSpeedSeive() {
		...
		long endingTime = System.nanoTime();
		System.out.println("Seive Way :" + (endingTime - startingTime) / 1000000);
	}
}
